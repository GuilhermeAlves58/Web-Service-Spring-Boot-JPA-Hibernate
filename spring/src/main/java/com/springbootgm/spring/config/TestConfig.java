package com.springbootgm.spring.config;
...
import com.springbootgm.spring.repositories.OrderItemRepository;
import com.springbootgm.spring.repositories.OrderRepository;
import com.springbootgm.spring.repositories.ProductRepository;
import com.springbootgm.spring.repositories.UserRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"),u2,OrderStatus.WAITING_PARYMENT); 
        Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), u1,OrderStatus.WAITING_PARYMENT);
